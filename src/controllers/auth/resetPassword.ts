 ...
 */
export const resetPassword = async (req: ResidentRequest, res: Response<ResidentResponse>): Promise<void> => {
  ...
  handleSuccessResponse({ res, message: MESSAGES.CHECK_EMAIL_RESET_LINK })
}
